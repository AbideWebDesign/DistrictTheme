				...
				<div class="modal fade" id="modalPopup" tabindex="-1" role="dialog" aria-labelledby="modalPopup" aria-hidden="true">
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							<?php if ( get_field('alert_image', get_the_ID()) ): ?>
								<div class="modal-header p-0">
									<div class="d-flex w-100 h-100 justify-content-center">
										<?php echo wp_get_attachment_image( get_field('alert_image', get_the_ID()), 'News Image Medium', false, array('class'=>'img-fluid w-100') ); ?>
									</div>
								</div>		
							<?php else: ?>
							...
							<div class="modal-body p-2 text-center">
								<h4 class="font-weight-bold text-uppercase text-primary"><?php the_field('alert_sub_title', get_the_ID()); ?></h4>
